...
class ProductosController
{
    ...
    {
        try {
            $productos = Table::query("SELECT id, nombre_producto, descripcion_producto, precio_unitario_producto, stock_producto, img_producto, slug_producto FROM productos");
